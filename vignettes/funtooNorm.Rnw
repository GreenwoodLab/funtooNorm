...
Extracting Signal_A and Signal_B from the Sample Methylation Profile or extracted directly from the IDAT files with Bioconductor package such as \textbf{illuminaio}}, \cite{Smith2013}.
